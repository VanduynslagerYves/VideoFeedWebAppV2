...
class ObjectDetectionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DetectObjects = channel.stream_stream(
                ...
                request_serializer=object__detection__pb2.ImageRequest.SerializeToString,
                response_deserializer=object__detection__pb2.ImageResponse.FromString,
...
def add_ObjectDetectionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'DetectObjects': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=object__detection__pb2.ImageRequest.FromString,
                    response_serializer=object__detection__pb2.ImageResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'ObjectDetection', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ObjectDetection', rpc_method_handlers)
...
class ObjectDetection(object):
    ...
    def DetectObjects(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/ObjectDetection/DetectObjects',
            object__detection__pb2.ImageRequest.SerializeToString,
            object__detection__pb2.ImageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
