...
public class WorkerOptionsMappingProfile : Profile
{
    ...
    {
        CreateMap<WorkerDbModel, WorkerOptions>()
        ...
        CreateMap<WorkerDbModel, CameraProperties>()
        ...
        CreateMap<ResolutionDbModel, CameraResolution>();

        CreateMap<WorkerDbModel, MotionDetectionOptions>()
